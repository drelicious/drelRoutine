...
if(isset($_POST['submitButton'])){ 
    ...
    if ($cursor) {
        if ($cursor->email == $email && $cursor->password == $password) {
    ...
    <section id="header-area">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <button style="border-color: #e0e0e0;" class="btn btn rounded-pill buttonlogin"><a href="/webapp/register.php" class="test"">Sign up</a></button>
            </div>
        </nav>
            ...
            <div class="card" style="width: 18rem; margin-top: 4%;">
                <div class="card-body">
                    ...
                    <form action="<?=$_SERVER['PHP_SELF'];?>" method="post">
                        ...
                        <p style="margin: 10px 0px" ><a href="/webapp/forgot-password.php" >Forgot Password?</a></p>
                        <button type="submit" name="submitButton" style="margin-top: 40px; border-color: #e0e0e0;" class="btn btn position-relative start-50 translate-middle rounded-pill buttonlogin">Login</button>
                    </form>
                    <?php
                    if (!$message == "") {
